...
### Dependencies
- **ch.admin.bit.jeap:jeap-internal-spring-boot-parent**: 10.0.0 → 11.0.0 (major)

## [3.0.0] - 2026-09-20

### Dependencies
- **ch.admin.bit.jeap:jeap-internal-spring-boot-parent**: 9.7.1 → 10.0.0 (major)
...
- Migrate wildcard-imported Spring Retry annotations and remove the dependency when no usages remain.
- Migrate wildcard-imported Spring Boot health contributor types.
